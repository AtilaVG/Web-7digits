...
(() => {
  ...
  if (!tabs) return;
  const DDATA = [
    { title: 'Borrado por software', desc: 'Sobreescritura certificada conforme a estándares internacionales. Ideal para equipos destinados a reventa o reutilización.', method: 'Overwrite multipaso', reuse: 'Sí — apto para segunda vida', norm: 'Certificado de borrado por unidad' },
    { title: 'Destrucción física', desc: 'Trituración mecánica del soporte. Elimina cualquier posibilidad de recuperación. Para información de máxima sensibilidad.', method: 'Trituración / shredding', reuse: 'No — soporte destruido', norm: 'Certificado de destrucción + gestión RAEE' },
    { title: 'Desmagnetización', desc: 'Campo magnético de alta intensidad (degaussing) que destruye irreversiblemente la estructura de datos magnéticos.', method: 'Degaussing', reuse: 'No — soporte inutilizado', norm: 'Certificado de destrucción por unidad' },
  ];
